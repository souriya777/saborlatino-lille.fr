...
if ( !function_exists('md_bone_scripts') ){
	function md_bone_scripts(){
		...
		wp_enqueue_script('raf-polyfill', get_template_directory_uri() . '/vendors/raf-polyfill.js', array(), false, true);
...
if ( ! function_exists( 'md_bone_webfont_css_backend' ) ) {
	function md_bone_webfont_css_backend() {
		...
		$body_font_selectors = '.editor-writing-flow';
...
/**
 * Add custom fields to image details popup
 */
if ( ! function_exists( 'md_bone_image_details_custom_fields_script') ) {
	function md_bone_image_details_custom_fields_script() {
	    wp_enqueue_script( 'image-details-custom-fields', get_template_directory_uri() . '/js/md-image-details-custom-fields.js', array(), null, true );
	}
}
add_action('print_media_templates', 'md_bone_image_details_custom_fields_script');
...
if ( !function_exists('md_bone_custom_css') ){
    function md_bone_custom_css() {
    	if (!is_admin()) {
	        ...
	        $border_color_selectors = '.fotorama__thumb-border,.tagcloud a:hover,.postTags-list > a:hover,.postVia-list > a:hover,.postSource-list > a:hover,.tabs-nav li.active a:after,.navigation--standard > ul > li > a:before,.articleTags-list > a:hover,input[type="submit"],input[type="submit"]:hover';
